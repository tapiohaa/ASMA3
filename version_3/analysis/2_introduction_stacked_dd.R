...
output_dd1_pri_morb = "W:/ASMA3/analysis/tables/intro_dd_pri_morb"
...
### ### ### ### ### ### ### ### ### ### ### ### ### 
#### 4.5: DD models: Prescriptions for diabeters or hypertension drugs. ####
### ### ### ### ### ### ### ### ### ### ### ### ###
...
models_pri = list(
  morb = list('morbidity', 1, NULL, NULL, 'Has Prescription'), 
  no_morb = list('morbidity', 0, NULL, NULL, 'The Rest')
)
...
# Estimate the results:
dd1.morb = results.dd(data=df, models = models_pri, specs = specs_pri)

# Mutate results to tidy tables:

table_dd1_morb = table.dd(models=c('Has Prescription', 'The Rest'), 
                          specs=specs_pri, results=dd1.morb, dd_type = 'dd1')

table_dd1_morb = rbind(table_dd1_morb$balanced_1$contacts_per_capita,
                       table_dd1_morb$balanced_1$contacts_per_capita_log)

save.table(
  table_dd1_morb, output=output_dd1_pri_morb,
  label_tex = 'tab:intro_dd_pri_morb',
  title_tex = 'Adoption: Between--Municipality DD Comparisons, Morbidities'
)
