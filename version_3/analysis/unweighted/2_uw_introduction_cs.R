...
output_dyn_cs_all_short = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_cs_all_short.pdf"
output_dyn_cs_pri_log =
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_cs_pri_log.pdf"
output_dyn_cs_pri_long = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_cs_pri_long.pdf"
output_att_plot_cs_pri = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_att_plot_cs_pri.pdf"
output_att_plot_cs_pri_log = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_att_plot_cs_pri_log.pdf"
output_att_plot_cs_sec = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_att_plot_cs_sec.pdf"
output_att_plot_cs_all = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_att_plot_cs_all.pdf"
output_attevent_plot_cs_pri = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_attevent_plot_cs_pri.pdf"
...
plot.es = function(data, otc, short_d=1, start_yr, all.p=0) {
  ...
  if(all.p==1) { DT = DT[mod=='all_pc']}
  else if(all.p==0) { DT = DT[mod!='all_pc']}
  ...
  if(otc %in% c('contacts_per_capita', 'contacts_per_capita_log') & all.p==0) {
