...
output_dyn_plot_pri = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_pri.pdf"
output_dyn_plot_sec = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_sec.pdf"
output_dyn_plot_all = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_all.pdf"
output_dyn_plot_pri_log = 
  "W:/ASMA3/analysis/unweighted/figures/uw_intro_dynamic_plot_pri_log.pdf"
...
output_dd1_all = "W:/ASMA3/analysis/unweighted/tables/uw_intro_dd_all"
output_dd1_inc = "W:/ASMA3/analysis/unweighted/figures/uw_intro_dd_inc.pdf"
...
dfs = lapply(models, function(mod) {
  ...
  data = data[, .(value = mean(outcome),
                  copay = mean(copayment, na.rm=TRUE)),
...
cairo_pdf(filename = output_dyn_plot_pri, width = 15, height = 10)
print(p1) 
dev.off()

cairo_pdf(filename = output_dyn_plot_sec, width = 15, height = 6)
print(p2 + p3) 
dev.off()

cairo_pdf(filename = output_dyn_plot_all, width = 15, height = 6)
print(p4) 
dev.off()

cairo_pdf(filename = output_dyn_plot_pri_log, width = 15, height = 10)
print(p5) 
dev.off()
...
cairo_pdf(filename = output_dd1_inc, width = 15, height = 7.5)
