...
* Check whether the person has diabetes or hypertension drug prescriptions;
%inc storage("0_comorbidities.sas");				* Approximately 5 minutes;
* Inputs: t141_522_2021_lm_2018_1_s + t141_522_2021_lm_2018_2_s + ;
* 			t141_522_2021_lm_2019_1_s + t141_522_2021_lm_2019_2_s (.sas7bdat);
* Outputs: comorbidities (.csv);
